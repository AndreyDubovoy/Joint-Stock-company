...
namespace Framework.Db
{
  ...
  {
    //----------------------------------------------------------------------------
    private CxCriteriaOperatorList m_Operators;
    private NxGroupOperatorType m_OperatorType;
    //----------------------------------------------------------------------------
    ...
    /// </summary>
    public CxCriteriaOperatorList Operators
    {
    ...
    /// </summary>
    public NxGroupOperatorType OperatorType
    {
