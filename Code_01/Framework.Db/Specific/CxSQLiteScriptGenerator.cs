...
namespace Framework.Db
{
  ...
  /// the specific SQLite syntax.
  /// </summary>
  internal class CxSQLiteScriptGenerator : CxDbScriptGenerator
  {
    //----------------------------------------------------------------------------
    /// <summary>
    /// Ctor.
    ...
    /*
    public CxSQLiteScriptGenerator(CxSQLiteConnection connection)
      : base(connection)
    {
    }
        */
    ...
    {
      return "SELECT data.* FROM (" + sqlText + ") data Limit " + topCount;
    }
    //----------------------------------------------------------------------------
    /// <summary>
