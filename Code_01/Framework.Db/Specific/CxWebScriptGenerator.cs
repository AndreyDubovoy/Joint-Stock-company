...
namespace Framework.Db
{
  ...
  internal class CxWebScriptGenerator: CxDbScriptGenerator
  {
    ...
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetLockClauseForSelect();
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
    ...
    public override string GetTopRecordsSqlText(string sqlText, int topCount)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetTopRecordsSqlText(sqlText, topCount);
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
    ...
    public override CxDbCommandDescription GetCountQueryForSelect(string select, CxCriteriaOperator criteria)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetCountQueryForSelect(select, criteria);
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
      ...
      bool simplifiedMode)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetPagedQueryForSelect(
      ...
      Dictionary<object, CxAggregateDescriptor> aggregateItems)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetQueryForSubGroups(
      ...
      CxSortDescriptorList sortings)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetQueryForPrimaryKeys(
    ...
    public override string RemoveTopClauseFromSelect(string select)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.RemoveTopClauseFromSelect(select);
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
      ...
      CxQueryDescriptor selectCommand, CxCriteriaOperator criteria, string fieldName)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetQueryForUniqueFieldValues(
    ...
    public override string AddRowCountLimitation(string sql, int rowCount)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.AddRowCountLimitation(sql, rowCount);
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
      ...
      CxSortDescriptorList sortings)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.GetQueryForAggregates(
    ...
    override public string PrepareParameterSubstitute(string name, int index)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.PrepareParameterSubstitute(name, index);
      }
    }
    //----------------------------------------------------------------------------
    /// <summary>
    ...
    override public string PrepareParameterName(string name, int index)
    {
      using (CxDbConnection connection = WebConnection.CreateTargetDbConnection())
      {
        return connection.ScriptGenerator.PrepareParameterName(name, index);
      }
    }
    //----------------------------------------------------------------------------
  }
